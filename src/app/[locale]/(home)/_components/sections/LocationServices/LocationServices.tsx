        ...
        <div className='container'>
          <div className='content'>
            <Image
              width={60}
              height={60}
              src='/images/home/LocationMarker.svg'
              alt='LocationMarker'
            />
            <h2>Turn on Location Services</h2>
            <p>
              Activate location services to discover the well-being you been
              always looking for - right next to your home.
            </p>
